...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
            ...
            while fecha_actual <= fecha_fin:
                ...
                obj, created = CalendarioDimension.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'es_festivo': False,  # Implementar festivos de Colombia si se necesita
                    }
                )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'✅ Calendario generado exitosamente: {total_creadas} fechas creadas para {start_year}-{end_year}'
            )
        )
